...
from google3.learning.brain.research.babelfish.lm.params.one_billion_wds import OneBWdsJFESN

topology_cell = 'topology'  # 'topology' # HOtopology


@model_registry.RegisterSingleTaskModel
class V01(OneBWdsJFESN):
